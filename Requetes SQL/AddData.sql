...
(9, '2023-11-12', '2023-11-25', 2, 29,'L’historique d’entraînement s’affiche avec deux jours de décalage par rapport à la date réelle des séances.','Le fuseau horaire du serveur principal était mal synchronisé avec celui de l’utilisateur. Ajout d’une conversion automatique basée sur l’heure locale.'),
